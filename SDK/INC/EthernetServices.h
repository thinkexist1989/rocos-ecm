...
*/
static EC_INLINESTART EC_T_WORD CalculateCrcRfc1071(EC_T_WORD* pWord, EC_T_WORD nLen)
{
    EC_T_WORD  wRetVal = 0;
    EC_T_DWORD dwCrc = 0;
...
typedef EC_T_BYTE (EC_FNCALL *EC_T_PF_COE_READ_CB)(EC_T_VOID* pvContext, EC_T_DWORD dwSimulatorId, EC_T_WORD wCfgFixedAddress, EC_T_WORD wIndex, EC_T_BYTE bySubindex, EC_T_DWORD dwSize, EC_T_BYTE* pbyData, EC_T_BOOL bCompleteAccess);
typedef EC_T_BYTE (EC_FNCALL *EC_T_PF_COE_WRITE_CB)(EC_T_VOID* pvContext, EC_T_DWORD dwSimulatorId, EC_T_WORD wCfgFixedAddress, EC_T_WORD wIndex, EC_T_BYTE bySubindex, EC_T_DWORD dwSize, EC_T_BYTE* pbyData, EC_T_BOOL bCompleteAccess);
