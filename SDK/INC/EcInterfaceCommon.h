...
typedef struct _EC_T_MASTER_INFO
{
    ...
    EC_T_DWORD              dwMasterVersionType;            /**< Master version type */
    EC_T_DWORD              adwReserved[22];
 ...
 * \return EC_E_NOERROR or error code
 */
typedef EC_T_DWORD(*EC_PF_DC_GETTIMEELAPSEDSINCECYCLESTART)(EC_T_VOID* pvContext, EC_T_DWORD* pdwTimeElapsedSinceCycleStartInNsec);
#include EC_PACKED_API_INCLUDESTART
 ...
 * \return EC_E_NOERROR or error code
 */
typedef EC_T_DWORD(*EC_PF_DC_ADJUSTCYCLETIME)(EC_T_VOID* pvContext, EC_T_INT nAdjustPermil);
#include EC_PACKED_API_INCLUDESTART
 ...
 * \return EC_E_NOERROR or error code
 */
typedef EC_T_DWORD(*EC_PF_DC_GETHOSTTIME)(EC_T_VOID* pvContext, EC_T_UINT64* pnActualHostTimeInNsec);
#include EC_PACKED_API_INCLUDESTART
...
{
    EC_T_DWORD  dwDetectionTimeout;                 /**< [in] Timeout [ms] for Group detection */
    EC_T_DWORD  dwRsvd[3];
...
typedef EC_T_VOID(*EC_T_FRAME_CALLBACK)(EC_T_VOID* pvContext, struct _EC_T_LINK_FRAMEDESC* pLinkFrameDesc, EC_T_DWORD dwFlags);
