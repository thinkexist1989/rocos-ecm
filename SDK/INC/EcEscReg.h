...
#define ECM_SB_EEP_SLV_EEPADDRESS                           ((EC_T_WORD)0x0504)
...
#define ECM_DCS_SYSTIMEDIFF                                 ((EC_T_WORD)0x092C)
...
#define ECM_DCS_REC_LATCHMODE                               ((EC_T_WORD)0x0936)
...
#define ECM_DCS_DC_ACTIVATION_STATUS                        ((EC_T_WORD)0x0984)
#define ECM_DCS_DC_SYNC0_STATUS                             ((EC_T_WORD)0x098E)
#define ECM_DCS_DC_SYNC1_STATUS                             ((EC_T_WORD)0x098F)
#define ECM_DCS_DC_WR_STARTCYCOP                            ((EC_T_WORD)0x0990)
#define ECM_DCS_DC_RD_TIMNEXTSYNC0                          ((EC_T_WORD)0x0990)
#define ECM_DCS_DC_RD_TIMNEXTSYNC1                          ((EC_T_WORD)0x0998)
...
#define ECM_DCL_LATCHCONTROL_REGISTER                       ((EC_T_WORD)0x09A8)
...
/* DCL */                                                      #define ECREG_DCL_CTRL_LATCH                                ((EC_T_WORD)0x09A8)
...
#define ECM_DCS_ECATBUFFER_CHANGE_EVENT_TIME                ((EC_T_WORD)0x09F0)
#define ECM_DCS_PDIBUFFER_START_EVENT_TIME                  ((EC_T_WORD)0x09F8)
#define ECM_DCS_PDIBUFFER_CHANGE_EVENT_TIME                 ((EC_T_WORD)0x09FC)

#define ECREG_ESC_SPECIFIC                                  ((EC_T_WORD)0x0E00)
#define ECREG_DIGITAL_IO_OUTPUT_DATA                        ((EC_T_WORD)0x0F00)
#define ECREG_GENERAL_PURPOSE_OUTPUTS                       ((EC_T_WORD)0x0F10)
#define ECREG_GENERAL_PURPOSE_INPUTS                        ((EC_T_WORD)0x0F18)
