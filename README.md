...
- <font color=#1E90FF>rocos_ecm</font> 主程序文件，运行时需要带一些参数（比如-f -v等），要以sudo运行
...
3. 以管理员身份启动主站，其命令行参数有两种方式：
  ...
  <table>
    ...
    <th><font color=#1E90FF>Path to ENI file. Note: On Windows CE absolute file paths are needed </font> </th>	
	</tr>
	<tr>
		<th ><font color=#1E90FF>-duration</font></th>
		<th><font color=#1E90FF>-duration (time)</font></th>
		<th><font color=#1E90FF>int32</font> </th>	
    <th><font color=#1E90FF>(time): Time in msec, 0 = forever (default = 120000).Running duration in msec. When the time expires, the demo application exits completely. </font> </th>	
	</tr>
  <tr>
  ...
  <tr>
		...
		<th><font color=#1E90FF>int32</font> </th>	
    <th><font color=#1E90FF>(level): Verbosity level: 0=off (default), 1..n=more messages. The verbosity level specifies how much console output messages will be generated by the demo application. A high verbosity level leads to more messages. </font> </th>	
	</tr>
  <tr>
...
The CPU affinity specifies which CPU the demo application ought to  </font> </th>	
	</tr>
  <tr>
		<th ><font color=#1E90FF>-perf</font></th>
		<th><font color=#1E90FF>-perf</font></th>
		<th><font color=#1E90FF>bool（可以无参数）</font> </th>	
    <th><font color=#1E90FF>Enable max. and average time measurement in μs for all EtherCAT jobs (e.g. ProcessAllRxFrames). </font> </th>	
	</tr>
  <tr>
		<th ><font color=#1E90FF>-auxclk</font></th>
		<th><font color=#1E90FF>-auxclk (period)</font></th>
		<th><font color=#1E90FF>int32</font> </th>	
    <th><font color=#1E90FF>(period): Clock period in μs (if supported by Operating System).参数必须大于10， 否则不开启auxclk </font> </th>	
	</tr>
  <tr>
		<th ><font color=#1E90FF>-sp</font></th>
		<th><font color=#1E90FF>-sp[port]</font></th>
		<th><font color=#1E90FF>int32</font> </th>	
    <th><font color=#1E90FF>If platform has support for IP Sockets, this commandline option enables the Remote API Server to be started with the EcMasterDemo. The Remote API Server is going to listen on TCP Port 6000 (or port parameter if given) and is available for connecting Remote API Clients. This option is included for attaching the EC-Lyser Application to the running master. </font> </th>	
	</tr>
  <tr>
		<th ><font color=#1E90FF>-log </font></th>
		<th><font color=#1E90FF>-log [prefix]</font></th>
		<th><font color=#1E90FF>string</font> </th>	
    <th><font color=#1E90FF>Use given file name prefix for log files. </font> </th>	
	</tr>
  <tr>
		<th ><font color=#1E90FF>-link</font></th>
		<th><font color=#1E90FF>-link(no)</font></th>
		<th><font color=#1E90FF>int32</font> </th>	
    <th><font color=#1E90FF>0 is i8254x, 1 is i8255x Hardware: Intel Pro/1000 network adapter card. </font> </th>	
	</tr>
  <tr>
		<th ><font color=#1E90FF>-instance</font></th>
		<th><font color=#1E90FF>-instance (no)</font></th>
		<th><font color=#1E90FF>string</font> </th>	
    <th><font color=#1E90FF>(instance): Device instance , 6号口是06:00.0 </font> </th>	
	</tr>
  <tr>
		<th ><font color=#1E90FF>-cpuidx</font></th>
		<th><font color=#1E90FF>-config (cfgFileName)</font></th>
  ...
  <tr>
		...
		<th><font color=#1E90FF>int32</font> </th>	
    <th><font color=#1E90FF>(mode): Mode 0 = Interrupt mode, 1= Polling mode. </font> </th>	
	</tr>
   <tr>
		<th ><font color=#1E90FF>-dcmmode</font></th>
		<th><font color=#1E90FF>-dcmmode(no)</font></th>
		<th><font color=#1E90FF>int32</font> </th>	
    <th><font color=#1E90FF>0 = off, 1 = busshift, 2 = mastershift. </font> </th>	
	</tr>
</table>
...
:bust_in_silhouette: **Yang Luo (yluo@hit.edu.cn)**